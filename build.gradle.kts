...
tasks.register<Jar>("buildPluginJar") {
    archiveFileName.set("boss-plugin-clipboard-history-${version}.jar")
    duplicatesStrategy = DuplicatesStrategy.EXCLUDE

    manifest {
        attributes(
            "Implementation-Title" to "BOSS Clipboard History Plugin",
            "Implementation-Version" to version,
            "Main-Class" to "ai.rever.boss.plugin.dynamic.clipboard.ClipboardDynamicPlugin"
        )
    }
